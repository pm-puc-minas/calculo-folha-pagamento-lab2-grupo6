...
//     */
//    List<FolhaPagamento> findByEmployee(Employee funcionario);
//
//    /**
...
//     */
//    List<FolhaPagamento> findByEmployeeOrderByAnoReferenciaDescMesReferenciaDesc(Employee funcionario);
//
//    /**
...
//     */
//    Optional<FolhaPagamento> findByEmployeeAndMesReferenciaAndAnoReferencia(
//            Employee funcionario, Integer mesReferencia, Integer anoReferencia);
//
//    /**
...
//     */
//    boolean existsByEmployeeAndMesReferenciaAndAnoReferencia(
//            Employee funcionario, Integer mesReferencia, Integer anoReferencia);
//
//    /**
...
//     */
//    @Query("SELECT f FROM Employee f WHERE f NOT IN " +
//           "(SELECT fp.funcionario FROM FolhaPagamento fp WHERE fp.mesReferencia = :mes AND fp.anoReferencia = :ano)")
//    List<Employee> findEmployeesSemFolhaNoPeriodo(@Param("mes") Integer mesReferencia, @Param("ano") Integer anoReferencia);
//}